...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function updateMessageBadge() {
        try {
            const response = await fetch('/staff/messages/api/unread-count');
            if (response.ok) {
    ...
    async function updateNotifications() {
        try {
            const response = await fetch('/staff/notifications');
            if (response.ok) {
    ...
    async function handleNotificationClick(event) {
        ...
        // Mark as read
        try {
            await fetch(`/staff/notifications/${notificationId}/read`, {
                method: 'POST',
                headers: {
        ...
        switch (notificationType) {
            case 'order':
                ...
                break;
            case 'low_stock':
                redirectUrl = '/staff/stocks';
                break;
            case 'promo_expiry':
                redirectUrl = '/staff/discounts';
                break;
            case 'report':
                redirectUrl = '/staff/analytics';
                break;
            case 'message':
                redirectUrl = '/staff/messages';
                break;
            default:
